...
INSERT INTO [dbo].[Garage]
     ...
     VALUES
			...
			('davids garage', 10, 2),
			('jorges garage', 14, 22),
			('Mistake garage', 20, 26),
			('Radiador garage', 10, 27),
			('Keyboard garage', 19, 28),
			('4Pillar garage', 25, 29),
			('JJ`s garage', 10, 30);
...
INSERT INTO [dbo].[Route]
     ...
     VALUES
			...
			('Route 01','From Roverly to Dahlonega'),
			('Route 02','From trekiskow to trampisko'),
			('Route 03','From Heroku to Mozilla'),
			('Route 03','From Grogu to trekiskow');
GO
...
INSERT INTO [dbo].[Driver]
     ...
     VALUES
			...
			('Laura', 'Gg Ave. 91', '545-8545-3', 27),
			('Gustavo', 'Kerios 568', '68-89512-88', 28),
			('michael', 'Pirotec ST.09', '40-845-60', 29);
